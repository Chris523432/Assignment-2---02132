...
class CPUTop extends Module {
  ...
  registerFile.io.bSel := Mux(controlUnit.io.memWrite || !controlUnit.io.writeEnable, programMemory.io.instructionRead(25, 21), programMemory.io.instructionRead(15, 11))
